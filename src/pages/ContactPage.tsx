  ...
  return (
    <div className="py-12 md:py-16">
      <div className="container-custom">
        <h1 className="mb-8 text-3xl font-bold md:text-4xl">{t('navigation.contact')}</h1>
          ...
          <div className="flex flex-col space-y-6">
            <div className="rounded-lg bg-white p-6 shadow-md">
              <h2 className="mb-4 text-2xl font-semibold text-neutral-900">
                {currentLang === 'en' ? 'Contact Information' : 'Informations de Contact'}
              </h2>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <ul className="space-y-2 text-neutral-700">
                <li className="flex justify-between">
                  <span>{currentLang === 'en' ? 'Monday - Friday' : 'Lundi - Vendredi'}</span>
                ...
                <li className="flex justify-between">
                  <span>{currentLang === 'en' ? 'Sunday & Holidays' : 'Dimanche & Jours Fériés'}</span>
            ...
            <div className="rounded-lg bg-primary-50 p-6 shadow-md">
              <h2 className="mb-4 text-2xl font-semibold text-neutral-900">
                {currentLang === 'en' ? 'Emergency Contact' : 'Contact d\'Urgence'}
              </h2>
        ...
        <div className="mt-12 overflow-hidden rounded-lg bg-white shadow-md">
          <div className="aspect-[16/9] w-full">
            ...
            <div className="flex h-full w-full items-center justify-center bg-neutral-100 p-8 text-center text-neutral-500">
              <p>
                {currentLang === 'en'
                  ? 'Interactive map would be displayed here'
                  : 'La carte interactive serait affichée ici'}
              </p>
            </div>
          </div>
        </div>
