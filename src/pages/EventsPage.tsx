        ...
        <div className="mb-12 flex flex-col justify-between md:flex-row md:items-end">
          <div>
            ...
            <p className="mt-4 text-lg text-neutral-600">
              {currentLang === 'en'
                ? 'Discover all upcoming city events and activities'
                : 'Découvrez tous les événements et activités à venir de la ville'}
            </p>
          </div>
          <button
            className="mt-4 flex items-center rounded-lg bg-white px-4 py-2 text-sm font-medium text-neutral-700 shadow-sm hover:bg-neutral-50 md:mt-0"
          ...
          <div className="rounded-lg bg-white p-8 text-center shadow-md">
            ...
            <p className="mt-2 text-neutral-600">
              {currentLang === 'en'
                ...
                : 'Essayez de supprimer vos filtres pour voir tous les événements'}
            </p>
            {activeCategories.length > 0 && (
              <button
